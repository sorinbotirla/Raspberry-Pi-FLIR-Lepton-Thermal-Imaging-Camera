...
log "[4/10] Apply boot edits..."
apply_boot_edits "/boot/firmware"

# Services and boot journals cleanup
...
# Default config.json (atomic creation if missing)
...
# Command FIFO for live control (/tmp is tmpfs, recreate every start)
